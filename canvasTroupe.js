window.onload = function () { //au chargement de la fenetre on applique notre fonction
		...
		getTroupe(); //recupere ton tableau rempli

		setTimeout(function () { 

		var chart = new CanvasJS.Chart("Troupe", {
		...
		function canvasTarifPlein(){
			...
			chart.options.title.text="Nombre de billet Plein Tarif vendu par Troupe";
			chart.options.data = [];
		...
		function canvasTarifReduit(){
			...
			chart.options.title.text="Nombre de billet Tarif Reduit vendu par Troupe"; // modifie le title du canvas
		...
		function canvasTarifEnfant(){
			...
			chart.options.title.text="Nombre de billets Enfant vendu par Troupe";
			chart.options.data = [];
			chart.options.data.push(donnees);
		...
		function canvasOffert(){
			...
			chart.options.title.text="Nombre de billet Offert par Troupe";
			chart.options.data = [];
			chart.options.data.push(donnees);
			chart.options.toolTip.content = popUpNoTot;
			chart.render();
		...
		function canvasSpecialeJ(){
			...
			chart.options.title.text="Nombre de billet Tarif SJ payé par Troupe";
			chart.options.data = [];
			chart.options.data.push(donnees);
		...
		function canvasSpecialeA(){
			...
			chart.options.title.text="Nombre de billet Tarif SA payé par Troupe";
			chart.options.data = [];
			chart.options.data.push(donnees);
